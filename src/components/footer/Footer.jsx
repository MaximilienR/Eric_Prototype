...
<div className="flex flex-col md:flex-row justify-start items-start max-w-6xl mx-auto p-6 gap-12">
        {/* Logo */}
        <div className="flex-1 flex justify-center md:justify-start mb-6 md:mb-0">
<img src={logo} alt="Logo" className="w-32 h-32 rounded-lg object-contain" />        </div>

        {/* Navigation */}
        <div className="flex-1 flex flex-col items-start space-y-4 text-lg">
        ...
        <div className="flex-1 flex flex-col items-start space-y-4 text-lg">
          ...
          <Link to="/confidentiel" className="hover:text-gray-200 transition whitespace-nowrap">
